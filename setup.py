...
setup(
  ...
  url = 'https://github.com/brunneis/vader-multi', # use the URL to the github repo
  download_url = 'https://github.com/brunneis/vader-multi/archive/master.zip',
  install_requires = ['requests', 'translatte'],
